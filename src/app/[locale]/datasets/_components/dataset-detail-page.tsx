...
export async function DatasetDetailPage({
  ...
  return (
    <main className="min-h-svh bg-background-light text-foreground">
      ...
      <section className="border-b px-4 py-12 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_22rem] lg:items-start">
          <div>
            ...
            <p className="mt-6 inline-flex items-center gap-2 rounded-md border border-border bg-background px-3 py-1.5 font-medium text-sm shadow-sm">
              <Database aria-hidden="true" className="size-4 text-primary" />
              {dataset.repositoryName}
            </p>
            <h1 className="mt-5 max-w-4xl text-balance font-heading font-semibold text-4xl leading-tight sm:text-5xl">
      ...
      <section className="px-4 py-10 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-7xl gap-5 lg:grid-cols-[1fr_1fr]">
          ...
          <section
            ...
            className="rounded-md border bg-card p-5 shadow-sm"
          >
            <h2 className="font-heading font-semibold text-xl" id="dataset-api">
              {t("apiEndpoints")}
            </h2>
            ...
            <ul className="mt-5 grid gap-2">
              {dataset.distributions.map((distribution) => (
                <li key={`${distribution.name}-${distribution.format}`}>
                  <a
                    className="flex items-center justify-between gap-3 rounded-md border bg-background px-3 py-2 text-sm transition hover:border-primary/50 hover:text-primary"
      ...
      <section className="px-4 pb-14 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl rounded-md border bg-card p-5 shadow-sm">
