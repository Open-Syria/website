...
export default function ErrorPage({ reset }: ErrorPageProps) {
  ...
  return (
    <main
      className="flex min-h-svh items-center bg-background-light py-16 text-foreground"
      id="main-content"
    >
      <section aria-labelledby="error-title" className="page-content">
        <div className="w-full max-w-2xl border-border/80 border-t pt-8">
