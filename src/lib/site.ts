export const siteConfig = {
  ...
  locales: {
    ar: {
      description:
        "OpenSyria يفتح البيانات السورية الموثوقة للباحثين والمطورين والصحفيين، عبر مجموعات بيانات قابلة للاستخدام وواجهات API واضحة.",
      ogLocale: "ar_SY",
      title: "OpenSyria | بيانات سورية مفتوحة وقابلة للاستخدام",
    },
    en: {
      description:
        "OpenSyria is a public data commons for reliable Syrian datasets, API access, and civic intelligence.",
